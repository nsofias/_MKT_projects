...
public class DSLMON_KPIs_object
    ...
    String availability_URL = "http://" + diligent_IP + ":8080/DSLMON/availability_dslams_WS.jsp";
    String retainability_URL = "http://" + diligent_IP + ":8080/DSLMON/retainability_dslams_WS.jsp";
    ...
    public boolean isRepeated(String myDslam)
        {
        DSLMON_KPIs_object myCCMInfo_object = new DSLMON_KPIs_object();
        try
            {
            myCCMInfo_object.updateKPIs(availability_URL, retainability_URL);
            double retain = this.getDslam_retain(myDslam);
