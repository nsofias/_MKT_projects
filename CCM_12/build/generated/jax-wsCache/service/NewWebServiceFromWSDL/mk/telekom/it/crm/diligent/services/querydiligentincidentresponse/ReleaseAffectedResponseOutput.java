 ...
 *         &amp;lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncidentResponse}ReleaseAffectedAsyncResponseOutput"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "ReleaseAffectedResponseOutput")
public class ReleaseAffectedResponseOutput {

    @XmlElement(required = true)
    protected EIMessageContext2 eiMessageContext;
    @XmlElement(required = true)
    protected ReleaseAffectedAsyncResponseOutput data;
     ...
     * @return
     *     possible object is
     *     {@link ReleaseAffectedAsyncResponseOutput }
     *     
     */
    public ReleaseAffectedAsyncResponseOutput getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(ReleaseAffectedAsyncResponseOutput value) {
        this.data = value;
    }
