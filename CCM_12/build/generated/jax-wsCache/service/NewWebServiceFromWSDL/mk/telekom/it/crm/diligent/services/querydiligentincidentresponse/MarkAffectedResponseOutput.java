 ...
 *         &amp;lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncidentResponse}MarkAffectedAsyncResponseOutput"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "MarkAffectedResponseOutput")
public class MarkAffectedResponseOutput {

    @XmlElement(required = true)
    protected EIMessageContext2 eiMessageContext;
    @XmlElement(required = true)
    protected MarkAffectedAsyncResponseOutput data;
     ...
     * @return
     *     possible object is
     *     {@link MarkAffectedAsyncResponseOutput }
     *     
     */
    public MarkAffectedAsyncResponseOutput getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(MarkAffectedAsyncResponseOutput value) {
        this.data = value;
    }
