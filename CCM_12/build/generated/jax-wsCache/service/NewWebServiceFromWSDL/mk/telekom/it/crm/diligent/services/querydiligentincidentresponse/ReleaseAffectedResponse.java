 ...
 *         &amp;lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncidentResponse}ReleaseAffectedAsyncResponse"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "ReleaseAffectedResponse")
public class ReleaseAffectedResponse {

    @XmlElement(required = true)
    protected EIMessageContext2 eiMessageContext;
    @XmlElement(required = true)
    protected ReleaseAffectedAsyncResponse data;
     ...
     * @return
     *     possible object is
     *     {@link ReleaseAffectedAsyncResponse }
     *     
     */
    public ReleaseAffectedAsyncResponse getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(ReleaseAffectedAsyncResponse value) {
        this.data = value;
    }
