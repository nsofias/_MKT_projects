 ...
 * 
 */
@WebServiceClient(name = "DiagnosticServicePortTypeService", targetNamespace = "http://servicediagnostictool.telekom.mk/service/diagnostic", wsdlLocation = "file:/C:/my%20files/JavaProjects/svt_skopia_wsdls/src-gen/wsdls/mk-telekom-servicediagnostictool-service-diagnostic/DiagnosticServicePortType.wsdl")
@HandlerChain(file = "DiagnosticServicePortTypeService_handler.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/my%20files/JavaProjects/svt_skopia_wsdls/src-gen/wsdls/mk-telekom-servicediagnostictool-service-diagnostic/DiagnosticServicePortType.wsdl");
