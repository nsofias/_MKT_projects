 ...
 *         &lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncident}ReleaseAffectedResponseType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ReleaseAffectedOutput", namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident")
public class ReleaseAffectedOutput {
    ...
    @XmlElement(namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident", required = true)
    protected ReleaseAffectedResponseType data;
     ...
     * @return
     *     possible object is
     *     {@link ReleaseAffectedResponseType }
     *     
     */
    public ReleaseAffectedResponseType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(ReleaseAffectedResponseType value) {
        this.data = value;
    }
