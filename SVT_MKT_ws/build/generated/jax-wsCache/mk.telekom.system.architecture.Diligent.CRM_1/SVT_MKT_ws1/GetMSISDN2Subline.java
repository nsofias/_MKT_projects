 ...
 *         &lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncident}GetMSISDN2SublineType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetMSISDN2Subline", namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident")
public class GetMSISDN2Subline {
    ...
    @XmlElement(namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident", required = true)
    protected GetMSISDN2SublineType data;
     ...
     * @return
     *     possible object is
     *     {@link GetMSISDN2SublineType }
     *     
     */
    public GetMSISDN2SublineType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(GetMSISDN2SublineType value) {
        this.data = value;
    }
