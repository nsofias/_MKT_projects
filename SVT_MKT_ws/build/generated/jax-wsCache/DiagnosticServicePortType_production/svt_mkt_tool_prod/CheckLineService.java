 ...
 *         &lt;element name="data" type="{http://servicediagnostictool.telekom.mk/datatypes/diagnostic}CheckLineServiceRequest"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CheckLineService", namespace = "http://servicediagnostictool.telekom.mk/service/diagnostic")
public class CheckLineService {
    ...
    @XmlElement(namespace = "http://servicediagnostictool.telekom.mk/service/diagnostic", required = true)
    protected CheckLineServiceRequest data;
     ...
     * @return
     *     possible object is
     *     {@link CheckLineServiceRequest }
     *     
     */
    public CheckLineServiceRequest getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(CheckLineServiceRequest value) {
        this.data = value;
    }
