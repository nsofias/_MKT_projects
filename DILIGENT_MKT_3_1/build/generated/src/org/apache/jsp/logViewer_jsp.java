...
public final class logViewer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (notice == null)
      ...
      out.write("\r\n");
      out.write("<form action=\"logViewer.jsp\">\r\n");
    ...
    if (errors != null)
        ...
        try
            ...
            try
                ...
                cmd.add("/opt/tomcat/apache-tomcat-8.5.37/logs/catalina.out");
                body += ("<p><h1>Diligent log file</h1>");
                body += new CmdProcessBuilder().runCommand(cmd).toString().replace("Exception", "<b><font color='red'>Exception</font></b>").replace(notice, "<b><font color='red'>"+notice+"</font></b>").replace("\n", "<p>");
                out.println(body);
                }
            catch (Exception e)
                {
