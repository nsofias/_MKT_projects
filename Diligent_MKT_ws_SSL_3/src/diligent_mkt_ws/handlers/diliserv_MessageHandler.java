 ...
 * @author nsofias
 */
public class diliserv_MessageHandler implements SOAPHandler<SOAPMessageContext>
    {
    ...
    public diliserv_MessageHandler()
        {
        }
    ...
    public boolean handleMessage(SOAPMessageContext messageContext)
        ...
        if (outInd)
            ...
            try
                {
                outlogOUT = new FileOutputStream(new File(System.getenv("APPLICATIONS_PATH") + "/xml/" + new TimeStamp1().getNowUnformated() + "diliserv_OUT.xml"), true);
                if (MODE == 1)
                    {
        ...
        //-------------------------
            ...
            try
                {
                outlogIN = new FileOutputStream(new File(System.getenv("APPLICATIONS_PATH") + "/xml/" + new TimeStamp1().getNowUnformated() + "diliserv_IN.xml"), true);
                if (MODE == 1)
                    {
