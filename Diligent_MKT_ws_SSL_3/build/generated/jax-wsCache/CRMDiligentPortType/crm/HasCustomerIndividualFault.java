 ...
 *         &lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncident}HasCustomerIndividualFaultType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "HasCustomerIndividualFault", namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident")
public class HasCustomerIndividualFault {
    ...
    @XmlElement(namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident", required = true)
    protected HasCustomerIndividualFaultType data;
     ...
     * @return
     *     possible object is
     *     {@link HasCustomerIndividualFaultType }
     *     
     */
    public HasCustomerIndividualFaultType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(HasCustomerIndividualFaultType value) {
        this.data = value;
    }
