 ...
 *         &amp;lt;element name="data" type="{http://oss.it.telekom.mk/tt/datatypes/stela-sync}stela-sync_synchRequest"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "SyncTTINCIDENT", namespace = "http://oss.it.telekom.mk/tt/services/stela-sync")
public class SyncTTINCIDENT {
    ...
    @XmlElement(namespace = "http://oss.it.telekom.mk/tt/services/stela-sync", required = true)
    protected StelaSyncSynchRequest data;
     ...
     * @return
     *     possible object is
     *     {@link StelaSyncSynchRequest }
     *     
     */
    public StelaSyncSynchRequest getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(StelaSyncSynchRequest value) {
        this.data = value;
    }
