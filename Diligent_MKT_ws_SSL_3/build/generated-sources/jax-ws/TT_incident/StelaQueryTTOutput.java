 ...
 *         &amp;lt;element name="data" type="{http://oss.it.telekom.mk/tt/datatypes/stela-sync}stela-sync_queryTTResponse"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "stelaQueryTTOutput", namespace = "http://oss.it.telekom.mk/tt/services/stela-sync")
public class StelaQueryTTOutput {
    ...
    @XmlElement(namespace = "http://oss.it.telekom.mk/tt/services/stela-sync", required = true)
    protected StelaSyncQueryTTResponse data;
     ...
     * @return
     *     possible object is
     *     {@link StelaSyncQueryTTResponse }
     *     
     */
    public StelaSyncQueryTTResponse getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(StelaSyncQueryTTResponse value) {
        this.data = value;
    }
