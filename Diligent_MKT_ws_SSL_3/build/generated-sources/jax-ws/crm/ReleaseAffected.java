 ...
 *         &lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncident}ReleaseAffectedType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ReleaseAffected", namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident")
public class ReleaseAffected {
    ...
    @XmlElement(namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident", required = true)
    protected ReleaseAffectedType data;
     ...
     * @return
     *     possible object is
     *     {@link ReleaseAffectedType }
     *     
     */
    public ReleaseAffectedType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(ReleaseAffectedType value) {
        this.data = value;
    }
