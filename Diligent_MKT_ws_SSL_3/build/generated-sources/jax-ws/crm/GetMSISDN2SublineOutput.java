 ...
 *         &lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncident}GetMSISDN2SublineResponseType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetMSISDN2SublineOutput", namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident")
public class GetMSISDN2SublineOutput {
    ...
    @XmlElement(namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident", required = true)
    protected GetMSISDN2SublineResponseType data;
     ...
     * @return
     *     possible object is
     *     {@link GetMSISDN2SublineResponseType }
     *     
     */
    public GetMSISDN2SublineResponseType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(GetMSISDN2SublineResponseType value) {
        this.data = value;
    }
