 ...
 *         &lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/queryDiligentIncident}MarkAffectedResponseType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "MarkAffectedOutput", namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident")
public class MarkAffectedOutput {
    ...
    @XmlElement(namespace = "http://crm.it.telekom.mk/diligent/services/queryDiligentIncident", required = true)
    protected MarkAffectedResponseType data;
     ...
     * @return
     *     possible object is
     *     {@link MarkAffectedResponseType }
     *     
     */
    public MarkAffectedResponseType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(MarkAffectedResponseType value) {
        this.data = value;
    }
