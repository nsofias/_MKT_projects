 ...
 *         &amp;lt;element name="data" type="{http://crm.it.telekom.mk/diligent/datatypes/Diligent}GetLineMetrics"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "GetLineMetrics")
public class GetLineMetrics {

    @XmlElement(required = true)
    protected EIMessageContext2 eiMessageContext;
    @XmlElement(required = true)
    protected mk.telekom.it.crm.diligent.datatypes.diligent.GetLineMetrics data;
     ...
     * @return
     *     possible object is
     *     {@link mk.telekom.it.crm.diligent.datatypes.diligent.GetLineMetrics }
     *     
     */
    public mk.telekom.it.crm.diligent.datatypes.diligent.GetLineMetrics getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(mk.telekom.it.crm.diligent.datatypes.diligent.GetLineMetrics value) {
        this.data = value;
    }
