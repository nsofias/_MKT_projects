 ...
 *         &lt;element name="data" type="{http://oss.it.telekom.mk/alat/datatypes/alatmanagement}alat_performSyncMeasureRequest"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PerformSyncMeasure", namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement")
public class PerformSyncMeasure {
    ...
    @XmlElement(namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement", required = true)
    protected AlatPerformSyncMeasureRequest data;
     ...
     * @return
     *     possible object is
     *     {@link AlatPerformSyncMeasureRequest }
     *     
     */
    public AlatPerformSyncMeasureRequest getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(AlatPerformSyncMeasureRequest value) {
        this.data = value;
    }
