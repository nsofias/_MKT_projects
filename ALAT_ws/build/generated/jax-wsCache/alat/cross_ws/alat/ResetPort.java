 ...
 *         &lt;element name="data" type="{http://oss.it.telekom.mk/alat/datatypes/alatmanagement}alat_resetPortRequest"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ResetPort", namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement")
public class ResetPort {
    ...
    @XmlElement(namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement", required = true)
    protected AlatResetPortRequest data;
     ...
     * @return
     *     possible object is
     *     {@link AlatResetPortRequest }
     *     
     */
    public AlatResetPortRequest getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(AlatResetPortRequest value) {
        this.data = value;
    }
