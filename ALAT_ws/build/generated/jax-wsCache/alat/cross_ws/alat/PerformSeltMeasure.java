 ...
 *         &lt;element name="data" type="{http://oss.it.telekom.mk/alat/datatypes/alatmanagement}alat_performSeltMeasureRequest"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PerformSeltMeasure", namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement")
public class PerformSeltMeasure {
    ...
    @XmlElement(namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement", required = true)
    protected AlatPerformSeltMeasureRequest data;
     ...
     * @return
     *     possible object is
     *     {@link AlatPerformSeltMeasureRequest }
     *     
     */
    public AlatPerformSeltMeasureRequest getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(AlatPerformSeltMeasureRequest value) {
        this.data = value;
    }
