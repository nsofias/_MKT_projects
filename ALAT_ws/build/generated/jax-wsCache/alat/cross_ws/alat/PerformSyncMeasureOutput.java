 ...
 *         &lt;element name="data" type="{http://oss.it.telekom.mk/alat/datatypes/alatmanagement}alat_performSyncMeasureResponse"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PerformSyncMeasureOutput", namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement")
public class PerformSyncMeasureOutput {
    ...
    @XmlElement(namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement", required = true)
    protected AlatPerformSyncMeasureResponse data;
     ...
     * @return
     *     possible object is
     *     {@link AlatPerformSyncMeasureResponse }
     *     
     */
    public AlatPerformSyncMeasureResponse getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(AlatPerformSyncMeasureResponse value) {
        this.data = value;
    }
