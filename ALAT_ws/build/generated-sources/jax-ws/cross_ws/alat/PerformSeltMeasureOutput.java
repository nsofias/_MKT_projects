 ...
 *         &lt;element name="data" type="{http://oss.it.telekom.mk/alat/datatypes/alatmanagement}alat_performSeltMeasureResponse"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PerformSeltMeasureOutput", namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement")
public class PerformSeltMeasureOutput {
    ...
    @XmlElement(namespace = "http://oss.it.telekom.mk/alat/services/alatmanagement", required = true)
    protected AlatPerformSeltMeasureResponse data;
     ...
     * @return
     *     possible object is
     *     {@link AlatPerformSeltMeasureResponse }
     *     
     */
    public AlatPerformSeltMeasureResponse getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(AlatPerformSeltMeasureResponse value) {
        this.data = value;
    }
