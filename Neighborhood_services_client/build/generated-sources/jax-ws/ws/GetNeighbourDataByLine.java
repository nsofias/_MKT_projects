 ...
 *         &amp;lt;element name="data" type="{http://diligent.it.telekom.mk/diligent/datatypes/NeighbourTool}GetNeighbourDataByLineRequest"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "GetNeighbourDataByLine", namespace = "http://diligent.it.telekom.mk/diligent/services/NeighbourTool")
public class GetNeighbourDataByLine {
    ...
    @XmlElement(namespace = "http://diligent.it.telekom.mk/diligent/services/NeighbourTool", required = true)
    protected GetNeighbourDataByLineRequest data;
     ...
     * @return
     *     possible object is
     *     {@link GetNeighbourDataByLineRequest }
     *     
     */
    public GetNeighbourDataByLineRequest getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(GetNeighbourDataByLineRequest value) {
        this.data = value;
    }
